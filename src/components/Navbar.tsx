      ...
      <div className="container flex items-center justify-between">
        <div className="flex items-center">
          <a href="#" className="flex flex-col">
            <span className="font-['Poppins'] text-pink-600 font-extrabold text-2xl">bloom</span>
            <span className="font-['poppins'] text-blue-800 text-center text-xs font-bold">moms deserve care too</span>
          </a>
        </div>
